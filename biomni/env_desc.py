...
library_content_dict = {
    ...
    "libreoffice": "[CLI Tool] A comprehensive office suite for document processing, conversion, and editing. Can OPEN, READ, and CONVERT various document formats including doc, docx files. Use with subprocess.run(['libreoffice', '--headless', '--convert-to', 'format', 'input_file', '--outdir', 'output_dir']) for batch conversion, or subprocess.run(['libreoffice', '--headless', '--convert-to', 'txt', 'document.docx']) for single file conversion. Supports formats: docx, doc, xlsx, xls, pptx, ppt, odt, ods, odp, pdf, txt, html, rtf.",
}
